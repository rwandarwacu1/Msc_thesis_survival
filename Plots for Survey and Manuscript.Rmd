...
ggplot(plot_data_diffbc, aes(x = time)) +
  ...
  labs(
    title = "Survival difference plot for group B and C",
    x = "Time (Years)",
    y = "Survival Difference (Group B - Group C)"
  ) +
  theme_minimal() +
  theme(
...
ggsurvplot(
  ...
  ggtheme = theme_minimal(),
  pval = FALSE,
  title= "Kaplan Meier plot for group B and D"
)  
```
...
ggplot(plot_data_diffbd, aes(x = time)) +
  ...
  scale_linetype_manual(name = "Reference", values = c("No Difference Line" = "dashed")) +
  labs(
    title = "Survival difference plot for group B and D",
    x = "Time (Years)",
    y = "Survival Difference (Group B - Group D)"
  ) +
  theme_minimal() +
  theme(
    legend.position = "right",  
