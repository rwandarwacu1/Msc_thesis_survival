...
$d_j$ denotes the number of deaths and the number of censored survival times, respectively, in this interval, $n_j$ is the number of individuals alive just before $t_{(j)}$ and $d_j$ deaths at $t_{(j)}$.
...
```{r interactiveplot, out.width='80%', echo=FALSE, fig.cap='Survival ', fig.height=4}
